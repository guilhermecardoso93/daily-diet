...
import { storageMealsGetAll, storageMealsHistorySave } from '../storage/meals/storageMeals'
...
type MealHistoryContextType = {
  ...
  fetchGetDetailMealById: (id: string) => ProductItemDTO
}
...
export function MealHistoryContextProvider({
  ...
  function fetchGetDetailMealById(id: string) {
